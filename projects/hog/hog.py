...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        if who == 0:
            gain, prev_score = score0 - previous_score, score0
            ...
            gain, prev_score = score1 - previous_score, score1
            prev_high = previous_high
            if gain > prev_high:
                prev_high = gain
                if gain != 1:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    max_score_roll = 1
    while k <= 10:
        current_avg = averaged_roll_dice(k ,dice)
        if current_avg > highest_avg:
            highest_avg = current_avg
            max_score_roll = k
        k += 1
    return max_score_roll
    # END PROBLEM 9
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    """
    # BEGIN PROBLEM 12
    stragegy = swap_strategy(score, opponent_score)
    bacon = bacon_strategy(score, opponent_score)
    always_roll_8 = always_roll(8)
