...
class Keyboard:
    ...
    def __init__(self, *args):
        ...
        self.buttons_value = {button.pos: button.key for button in args}
    ...
    def press(self, info):
        ...
        return self.buttons_value[info]
    ...
    def typing(self, typing_input):
        ...
        for key in typing_input:
            s += self.buttons_value[key]
            self.buttons[key].pressed += 1
        return s
...
def make_advanced_counter_maker():
    ...
    def counter_maker():
        own_count = 0
        def counter(instruction):
            nonlocal count, own_count
            if instruction == 'count':
                ...
                own_count = 0
            else: # instruction is 'global-reset'
                count = 0
        return counter 
