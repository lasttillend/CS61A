...
# scheme_read do syntatical analysis, checks the structure of the input text and returns a structured Python expression, for example, Pair(1, Pair(2, nil)), that is equivalent to the Scheme expression you typed in.
def scheme_read(src):
